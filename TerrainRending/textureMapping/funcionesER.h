	...
	public:
		...
		*/
		...
		void readFloorInside(int it, float x, float y, float paso){
			m_floor_points[it*6  ] = point3(x    ,0.0/*noise(x,y)*/    	 ,y    );
			m_floor_points[it*6+1] = point3(x+paso,0.0/*noise(x+paso,y)*/ 	 ,y    );
			m_floor_points[it*6+2] = point3(x    ,0.0/*noise(x,y+paso)*/ 	 ,y+paso);

			m_floor_points[it*6+3] = point3(x+paso,0.0/*noise(x+paso,y)*/ 	 ,y    );
			m_floor_points[it*6+4] = point3(x    ,0.0/*noise(x,y+paso)*/ 	 ,y+paso);
			m_floor_points[it*6+5] = point3(x+paso,0.0/*noise(x+paso,y+paso)*/ ,y+paso);
		}
